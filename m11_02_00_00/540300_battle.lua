...
Goal.Activate = function (arg0, arg1, arg2)
    ...
    f2_local0[2] = SetCoolTime(arg1, arg2, 3007, 30, f2_local0[2], 1)
    f2_local0[2] = SetCoolTime(arg1, arg2, 3091, 30, f2_local0[2], 1)
    ...
    f2_local0[14] = SetCoolTime(arg1, arg2, 3042, 120, f2_local0[14], 1)
    f2_local0[15] = SetCoolTime(arg1, arg2, 3043, 120, f2_local0[15], 1)
    ...
    f2_local0[33] = SetCoolTime(arg1, arg2, 3042, 30, f2_local0[33], 1)
    f2_local0[34] = SetCoolTime(arg1, arg2, 3043, 30, f2_local0[34], 1)
...
Goal.Act01 = function (arg0, arg1, arg2)
    ...
    local f3_local5 = 3
    local f3_local6 = 3
    local f3_local7 = arg0:GetDist(TARGET_SELFNE_0)
    ...
    if f3_local7 <= 6 then
        ...
        arg1:AddSubGoal(GOAL_COMMON_ComboAttackTunableSpin, 10, 3024, TARGET_ENE_0, f3_local8, f3_local10, f3_local11, 0, 0)
    end
    arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, 3000, TARGET_ENE_0, f3_local8, f3_local10, f3_local11, 0, 0)
...
Goal.Act02 = function (arg0, arg1, arg2)
    ...
    local f4_local7 = 0
    local f4_local8 = 0
    arg1:AddSubGoal(GOAL_COMMON_AttackTunableSpin, 10, 3006, TARGET_ENE_0, 1, f4_local7, f4_local8, 0, 0)
    arg0:SetTimer(2, 30)
    GetWellSpace_Odds = 100
    arg0:SetNumber(3, 1)
    return GetWellSpace_Odds
...
Goal.Act06 = function (arg0, arg1, arg2)
    ...
    arg1:AddSubGoal(GOAL_COMMON_ComboAttackTunableSpin, 10, 3004, TARGET_ENE_0, 9999, 0, 0, 0, 0)
    arg1:AddSubGoal(GOAL_COMMON_ComboFinal, 10, 3005, TARGET_ENE_0, 9999, 0, 0, 0, 0)
    arg0:SetNumber(3, 0)
    GetWellSpace_Odds = 100
    return GetWellSpace_Odds
...
Goal.Act09 = function (arg0, arg1, arg2)
    ...
    if f11_local0 <= 0.66 then
        arg1:AddSubGoal(GOAL_COMMON_ComboFinal, 10, 3042, TARGET_ENE_0, 9999, f11_local1, f11_local2, 0, 0)
    end
    GetWellSpace_Odds = 100
    return GetWellSpace_Odds
...
Goal.Act14 = function (arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_ComboAttackTunableSpin, 0.3, 3042, TARGET_ENE_0, 999, TurnTime, FrontAngle, 0, 0)
    GetWellSpace_Odds = 100
    return GetWellSpace_Odds
...
Goal.Act15 = function (arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_ComboAttackTunableSpin, 10, 3043, TARGET_ENE_0, 999, TurnTime, FrontAngle, 0, 0)
    GetWellSpace_Odds = 100
    return GetWellSpace_Odds
...
Goal.Act33 = function (arg0, arg1, arg2)
    ...
    local f35_local7 = 0
    local f35_local8 = 0
    local f35_local9 = arg1:AddSubGoal(GOAL_COMMON_AttackTunableSpin, 10, 3042, TARGET_ENE_0, 1, f35_local7, f35_local8, 0, 0)
    f35_local9:TimingSetNumber(8, 1, AI_TIMING_SET__ACTIVATE)
    GetWellSpace_Odds = 100
    return GetWellSpace_Odds
...
Goal.Act34 = function (arg0, arg1, arg2)
    ...
    local f36_local7 = 0
    local f36_local8 = 0
    local f36_local9 = arg1:AddSubGoal(GOAL_COMMON_AttackTunableSpin, 10, 3043, TARGET_ENE_0, 1, f36_local7, f36_local8, 0, 0)
    f36_local9:TimingSetNumber(8, 1, AI_TIMING_SET__ACTIVATE)
    GetWellSpace_Odds = 100
    return GetWellSpace_Odds
...
Goal.Act39 = function (arg0, arg1, arg2)
    ...
    local f37_local3 = arg0:GetRandam_Int(30, 45)
    if SpaceCheck(arg0, arg1, 180, 5) then
        arg1:AddSubGoal(GOAL_COMMON_SpinStep, f37_local0, 5201, TARGET_ENE_0, f37_local1, AI_DIR_TYPE_B, 0)
        f37_local2 = 3.5
    end
    local f37_local4 = 0
    if SpaceCheck(arg0, arg1, -90, 1) == true then
    ...
    arg1:AddSubGoal(GOAL_COMMON_SidewayMove, f37_local2, TARGET_ENE_0, f37_local4, f37_local3, true, true, -1)
    return GETWELLSPACE_ODDS
...
Goal.Interrupt = function (arg0, arg1, arg2)
    ...
    local f39_local1 = arg1:GetDist(TARGET_ENE_0)
    local f39_local2 = arg1:GetRandam_Int(1, 100)
    local f39_local3 = arg1:GetSpecialEffectInactivateInterruptType(0)
    local f39_local4 = arg1:GetSpRate(TARGET_SELF)
    ...
    if arg1:IsInterupt(INTERUPT_ActivateSpecialEffect) then
        ...
        elseif f39_local0 == 5028 then
            if f39_local1 <= 2.5 - arg1:GetMapHitRadius(TARGET_SELF) - 0.5 then
                arg2:ClearSubGoal()
        ...
        elseif f39_local0 == 5032 and f39_local1 <= 3 - arg1:GetMapHitRadius(TARGET_SELF) then
            arg2:ClearSubGoal()
            arg2:AddSubGoal(GOAL_COMMON_ComboFinal, 3, 3077, TARGET_ENE_0, 999, 0, 0, 0, 0)
            return true
        elseif f39_local0 == 5032 and f39_local1 >= 10 and arg1:GetNumber(9) == 0 then
            arg2:ClearSubGoal()
            arg2:AddSubGoal(GOAL_COMMON_ComboFinal, 10, 3091, TARGET_ENE_0, 9999, 0, 0, 0, 0)
            arg1:SetTimer(12, 2)
            arg1:SetNumber(9, 1)
            return true
        elseif f39_local0 == 5034 and arg1:HasSpecialEffectId(TARGET_SELF, 200050) then
            if f39_local2 <= 60 then
                if f39_local1 <= 4.2 - arg1:GetMapHitRadius(TARGET_SELF) and arg1:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_F, 120) then
                    ...
                    return true
                elseif f39_local1 <= 4.2 - arg1:GetMapHitRadius(TARGET_SELF) and arg1:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_F, 120) then
                    arg2:ClearSubGoal()
                    arg2:AddSubGoal(GOAL_COMMON_ComboFinal, 3, 3012, TARGET_ENE_0, 999, 0, 0, 0, 0)
                    return true
                elseif f39_local1 <= 4 - arg1:GetMapHitRadius(TARGET_SELF) and arg1:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_B, 240) then
                    arg2:ClearSubGoal()
        ...
        elseif f39_local0 == 5037 and f39_local1 <= 4 - arg1:GetMapHitRadius(TARGET_SELF) and not arg1:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_R, 90) then
        ...
        elseif f39_local0 == 5039 and f39_local4 <= 0.5 then
            arg2:ClearSubGoal()
            arg2:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, 3042, TARGET_ENE_0, 999, 0, 0, 0, 0)
            return true
        elseif f39_local0 == 110112 and arg1:HasSpecialEffectId(TARGET_SELF, 3540020) then
            arg2:ClearSubGoal()
            arg2:AddSubGoal(GOAL_COMMON_ComboFinal, 0.1, 3046, TARGET_ENE_0, 999, 0, 0, 0, 0)
            return true
        elseif f39_local0 == 110113 and arg1:HasSpecialEffectId(TARGET_SELF, 3540020) then
            arg2:ClearSubGoal()
            arg2:AddSubGoal(GOAL_COMMON_ComboFinal, 0.1, 3049, TARGET_ENE_0, 999, 0, 0, 0, 0)
            return true
        elseif f39_local0 == 110114 and arg1:HasSpecialEffectId(TARGET_SELF, 3540020) then
            arg2:ClearSubGoal()
...
Goal.Kengeki_Activate = function (arg0, arg1, arg2, arg3)
    local f41_local0 = ReturnKengekiSpecialEffect(arg1)
    ...
    local f41_local5 = arg1:GetSpRate(TARGET_SELF)
    local f41_local6 = arg1:GetNinsatsuNum()
    if f41_local5 <= 0 then
        ...
        elseif f41_local0 == 200229 and arg1:GetNumber(0) >= 5 then
            arg1:SetNumber(0, 0)
            f41_local1[8] = 500
            f41_local1[4] = 500
        else
    ...
    f41_local1[1] = SetCoolTime(arg1, arg2, 3071, 8, f41_local1[1], 1)
    f41_local1[2] = SetCoolTime(arg1, arg2, 3060, 8, f41_local1[2], 1)
    f41_local1[3] = SetCoolTime(arg1, arg2, 3075, 8, f41_local1[3], 1)
    f41_local1[4] = SetCoolTime(arg1, arg2, 3007, 12, f41_local1[4], 1)
    f41_local1[4] = SetCoolTime(arg1, arg2, 3072, 12, f41_local1[4], 1)
    f41_local1[4] = SetCoolTime(arg1, arg2, 3077, 12, f41_local1[4], 1)
    f41_local1[4] = SetCoolTime(arg1, arg2, 3006, 12, f41_local1[4], 1)
    f41_local1[4] = SetCoolTime(arg1, arg2, 3091, 12, f41_local1[4], 1)
    f41_local1[5] = SetCoolTime(arg1, arg2, 3009, 12, f41_local1[5], 1)
    f41_local1[6] = SetCoolTime(arg1, arg2, 3011, 12, f41_local1[6], 1)
    f41_local1[7] = SetCoolTime(arg1, arg2, 3026, 8, f41_local1[7], 1)
    f41_local1[8] = SetCoolTime(arg1, arg2, 5201, 15, f41_local1[8], 1)
    f41_local1[9] = SetCoolTime(arg1, arg2, 3071, 15, f41_local1[9], 1)
    f41_local1[11] = SetCoolTime(arg1, arg2, 3003, 15, f41_local1[11], 1)
    f41_local1[12] = SetCoolTime(arg1, arg2, 3077, 8, f41_local1[12], 1)
    f41_local1[13] = SetCoolTime(arg1, arg2, 3080, 8, f41_local1[13], 1)
    f41_local1[14] = SetCoolTime(arg1, arg2, 3081, 8, f41_local1[14], 1)
    f41_local1[15] = SetCoolTime(arg1, arg2, 3011, 15, f41_local1[15], 1)
    f41_local1[17] = SetCoolTime(arg1, arg2, 3009, 8, f41_local1[17], 1)
    f41_local1[20] = SetCoolTime(arg1, arg2, 5201, 10, f41_local1[20], 1)
    f41_local1[21] = SetCoolTime(arg1, arg2, 3050, 15, f41_local1[21], 1)
    f41_local1[22] = SetCoolTime(arg1, arg2, 3042, 15, f41_local1[22], 1)
    f41_local1[31] = SetCoolTime(arg1, arg2, 3072, 25, f41_local1[22], 1)
    ...
    f41_local2[15] = REGIST_FUNC(arg1, arg2, arg0.Kengeki15)
    f41_local2[16] = REGIST_FUNC(arg1, arg2, arg0.Kengeki16)
    f41_local2[17] = REGIST_FUNC(arg1, arg2, arg0.Kengeki17)
    f41_local2[18] = REGIST_FUNC(arg1, arg2, arg0.Kengeki18)
    f41_local2[19] = REGIST_FUNC(arg1, arg2, arg0.Kengeki19)
    ...
    f41_local2[24] = REGIST_FUNC(arg1, arg2, arg0.Kengeki24)
    f41_local2[25] = REGIST_FUNC(arg1, arg2, arg0.Kengeki25)
    f41_local2[26] = REGIST_FUNC(arg1, arg2, arg0.Kengeki26)
    f41_local2[27] = REGIST_FUNC(arg1, arg2, arg0.Kengeki27)
    ...
    local f41_local7 = REGIST_FUNC(arg1, arg2, arg0.ActAfter_AdjustSpace)
    return Common_Kengeki_Activate(arg1, arg2, f41_local1, f41_local2, f41_local7, f41_local3)
...
Goal.Kengeki05 = function (arg0, arg1, arg2)
    ...
    local f46_local3 = -1
    local f46_local4 = arg0:GetRandam_Int(30, 60)
    local f46_local5 = arg0:GetRandam_Int(1, 100)
    local f46_local6 = 1
    arg1:ClearSubGoal()
...
Goal.Kengeki12 = function (arg0, arg1, arg2)
    arg1:ClearSubGoal()
    arg1:AddSubGoal(GOAL_COMMON_EndureAttack, 10, 3077, TARGET_ENE_0, 9999, 0)
    
end

Goal.Kengeki13 = function (arg0, arg1, arg2)
    arg1:ClearSubGoal()
    arg1:AddSubGoal(GOAL_COMMON_EndureAttack, 10, 3080, TARGET_ENE_0, 9999, 0)
    
end

Goal.Kengeki14 = function (arg0, arg1, arg2)
    arg1:ClearSubGoal()
    arg1:AddSubGoal(GOAL_COMMON_EndureAttack, 10, 3081, TARGET_ENE_0, 9999, 0)
...
Goal.Kengeki27 = function (arg0, arg1, arg2)
    local f57_local0 = arg0:GetRandam_Int(1, 100)
    local f57_local1 = arg0:GetRandam_Int(1, 100)
    arg1:ClearSubGoal()
    arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, 3065, TARGET_ENE_0, 2.8 - arg0:GetMapHitRadius(TARGET_SELF), 0, 0)
    
end

Goal.Kengeki30 = function (arg0, arg1, arg2)
    arg1:ClearSubGoal()
    arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, 3042, TARGET_ENE_0, 9999, 0, 0, 0, 0)
