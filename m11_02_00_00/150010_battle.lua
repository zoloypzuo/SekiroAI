RegisterTableGoal(GOAL_MurabitoZombie_kumade_150010_Battle, "GOAL_MurabitoZombie_kumade_150010_Battle")
REGISTER_GOAL_NO_UPDATE(GOAL_MurabitoZombie_kumade_150010_Battle, true)
...
Goal.Act22 = function (arg0, arg1, arg2)
    local f7_local0 = 3
    local f7_local1 = 0
    local f7_local2 = arg0:GetDist(TARGET_FRI_0)
    local f7_local3 = arg0:GetRandam_Int(1, 100)
    if SpaceCheck(arg0, arg1, -45, 2) == true and SpaceCheck(arg0, arg1, 45, 2) == true and f7_local2 >= 2.5 then
        if f7_local3 <= 50 then
            arg1:AddSubGoal(GOAL_COMMON_SpinStep, f7_local0, 5212, TARGET_ENE_0, f7_local1, AI_DIR_TYPE_L, 0)
        else
            arg1:AddSubGoal(GOAL_COMMON_SpinStep, f7_local0, 5213, TARGET_ENE_0, f7_local1, AI_DIR_TYPE_R, 0)
        end
    elseif arg0:IsInsideTarget(TARGET_FRI_0, AI_DIR_TYPE_R, 100) and SpaceCheck(arg0, arg1, -45, 2) == true and f7_local2 <= 2.5 then
        arg1:AddSubGoal(GOAL_COMMON_SpinStep, f7_local0, 5212, TARGET_ENE_0, f7_local1, AI_DIR_TYPE_L, 0)
    elseif arg0:IsInsideTarget(TARGET_FRI_0, AI_DIR_TYPE_L, 100) and SpaceCheck(arg0, arg1, 45, 2) == true and f7_local2 <= 2.5 then
        arg1:AddSubGoal(GOAL_COMMON_SpinStep, f7_local0, 5213, TARGET_ENE_0, f7_local1, AI_DIR_TYPE_R, 0)
...
Goal.Act23 = function (arg0, arg1, arg2)
    ...
    local f8_local1 = arg0:GetDist(TARGET_FRI_0)
    local f8_local2 = arg0:GetSp(TARGET_SELF)
    local f8_local3 = 20
    local f8_local4 = arg0:GetRandam_Int(1, 100)
    local f8_local5 = -1
    local f8_local6 = arg0:GetRandam_Int(0, 1)
    if arg0:IsInsideTarget(TARGET_FRI_0, AI_DIR_TYPE_R, 100) and SpaceCheck(arg0, arg1, -90, 1) == true and f8_local1 <= 2.5 then
        f8_local6 = 0
    elseif arg0:IsInsideTarget(TARGET_FRI_0, AI_DIR_TYPE_L, 100) and SpaceCheck(arg0, arg1, 90, 1) == true and f8_local1 <= 2.5 then
        f8_local6 = 1
    end
    local f8_local7 = 3
    local f8_local8 = arg0:GetRandam_Int(30, 45)
    arg0:SetNumber(10, f8_local6)
    local f8_local9 = arg1:AddSubGoal(GOAL_COMMON_SidewayMove, f8_local7, TARGET_ENE_0, f8_local6, f8_local8, true, true, f8_local5)
    f8_local9:TimingSetTimer(2, 4, UPDATE_SUCCESS)
    GetWellSpace_Odds = 100
    return GetWellSpace_Odds
...
Goal.Act28 = function (arg0, arg1, arg2)
    ...
    local f13_local1 = arg0:GetRandam_Float(1, 3.5)
    ...
    elseif f13_local0 <= 10 then
        arg1:AddSubGoal(GOAL_COMMON_ApproachTarget, f13_local2, TARGET_ENE_0, 7.9, TARGET_SELF, true, -1)
    else
        arg1:AddSubGoal(GOAL_COMMON_ApproachTarget, f13_local2, TARGET_ENE_0, 9.9, TARGET_SELF, false, -1)
    end
    GetWellSpace_Odds = 0
    return GetWellSpace_Odds
...
Goal.Act29 = function (arg0, arg1, arg2)
    ...
    local f14_local1 = 7
    local f14_local2 = 0
    local f14_local3 = arg0:GetRandam_Float(1, 3.5)
    arg1:AddSubGoal(GOAL_COMMON_LeaveTarget, f14_local3, TARGET_ENE_0, f14_local1, TARGET_ENE_0, true, -1)
    
end

Goal.Act30 = function (arg0, arg1, arg2)
    local f15_local0 = 3.5
    local f15_local1 = arg0:GetRandam_Int(30, 45)
    local f15_local2 = 0
    ...
    arg1:AddSubGoal(GOAL_COMMON_SidewayMove, f15_local0, TARGET_ENE_0, f15_local2, f15_local1, true, true, -1)
    GetWellSpace_Odds = 0
    return GetWellSpace_Odds
...
Goal.Act35 = function (arg0, arg1, arg2)
    ...
    local f16_local2 = arg0:GetRandam_Int(0, 1)
    local f16_local3 = arg0:GetRandam_Float(2, 3.5)
    local f16_local4 = 3
    local f16_local5 = 0
    local f16_local6 = arg0:GetDist(TARGET_FRI_0)
    local f16_local7 = arg0:GetRandam_Int(1, 100)
    local f16_local8 = arg0:GetRandam_Float(6.5, 7.5)
    local f16_local9 = arg0:GetRandam_Float(5.5, 6.5)
    local f16_local10 = 999
    local f16_local11 = 100
    if f16_local0 >= 10 then
        Approach_Act(arg0, arg1, f16_local8, f16_local10, 0, 3)
    elseif f16_local0 >= 5 then

    elseif f16_local0 >= 3.5 then
        arg1:AddSubGoal(GOAL_COMMON_LeaveTarget, 3, TARGET_ENE_0, f16_local8, TARGET_ENE_0, false, 9910)
    else
        arg1:AddSubGoal(GOAL_COMMON_SpinStep, 5, 5201, TARGET_ENE_0, 0, AI_DIR_TYPE_B, 2)
    end
    local f16_local12 = arg1:AddSubGoal(GOAL_COMMON_SidewayMove, f16_local3, TARGET_ENE_0, f16_local2, arg0:GetRandam_Int(30, 45), true, true, 9910)
    f16_local12:TimingSetTimer(2, 4, UPDATE_SUCCESS)
    GetWellSpace_Odds = 0
    return GetWellSpace_Odds
...
Goal.Act36 = function (arg0, arg1, arg2)
    ...
    if f17_local1 <= 34 then
        arg0:SetEventMoveTarget(1502296)
    elseif f17_local1 <= 67 then
        arg0:SetEventMoveTarget(1502297)
    else
        arg0:SetEventMoveTarget(1502298)
    end
    arg1:AddSubGoal(GOAL_COMMON_ApproachTarget, 3, POINT_EVENT, f17_local0, POINT_EVENT, false, -1)
...
Goal.Damaged = function (arg0, arg1, arg2)
    ...
    if f20_local3 <= 33 then
        arg1:ClearSubGoal()
        local f20_local5 = arg1:AddSubGoal(GOAL_COMMON_SpinStep, StepLife, 5211, TARGET_ENE_0, TurnTime, AI_DIR_TYPE_B, 0)
        f20_local5:TimingSetTimer(3, 6, UPDATE_SUCCESS)
        return true
...
Goal.ActAfter_AdjustSpace = function (arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_MurabitoZombie_kumade_150010_AfterAttackAct, 10)
...
RegisterTableGoal(GOAL_MurabitoZombie_kumade_150010_AfterAttackAct, "GOAL_MurabitoZombie_kumade_150010_AfterAttackAct")
REGISTER_GOAL_NO_SUB_GOAL(GOAL_MurabitoZombie_kumade_150010_AfterAttackAct, true)
Goal.Activate = function (arg0, arg1, arg2)
    local f24_local0 = arg1:GetDist(TARGET_ENE_0)
    local f24_local1 = arg1:GetToTargetAngle(TARGET_ENE_0)
    local f24_local2 = arg1:GetHpRate(TARGET_SELF)
    local f24_local3 = {}
    ...
    local f24_local4 = SelectOddsIndex(arg1, f24_local3)
