...
Goal.Act30 = function (arg0, arg1, arg2)
    ...
    local f28_local7 = 0
    local f28_local8 = 0
    arg1:AddSubGoal(GOAL_COMMON_ComboAttackTunableSpin, 10, 3003, TARGET_ENE_0, 9999, f28_local7, f28_local8, 0, 0)
    GetWellSpace_Odds = 100
    return GetWellSpace_Odds
...
Goal.Act31 = function (arg0, arg1, arg2)
    ...
    local f29_local7 = 0
    local f29_local8 = 0
    arg1:AddSubGoal(GOAL_COMMON_ComboAttackTunableSpin, 10, 3004, TARGET_ENE_0, 9999, f29_local7, f29_local8, 0, 0)
    GetWellSpace_Odds = 100
    return GetWellSpace_Odds
...
Goal.Act32 = function (arg0, arg1, arg2)
    ...
    local f30_local7 = 0
    local f30_local8 = 0
    arg1:AddSubGoal(GOAL_COMMON_ComboAttackTunableSpin, 10, 3004, TARGET_ENE_0, 9999, f30_local7, f30_local8, 0, 0)
    GetWellSpace_Odds = 100
    return GetWellSpace_Odds
...
Goal.Act42 = function (arg0, arg1, arg2)
    ...
    local f37_local8 = 0
    if arg0:GetNinsatsuNum() >= 2 or arg0:GetTimer(11) > 0 then
        arg1:AddSubGoal(GOAL_COMMON_ComboAttackTunableSpin, 10, 3009, TARGET_ENE_0, 7, f37_local7, f37_local8, 0, 0)
    else
        local f37_local9 = arg1:AddSubGoal(GOAL_COMMON_ComboAttackTunableSpin, 10, 3056, TARGET_ENE_0, 7, f37_local7, f37_local8, 0, 0)
        f37_local9:TimingSetTimer(11, 8, AI_TIMING_SET__ACTIVATE)
    end
    arg0:SetNumber(5, 1)
    GetWellSpace_Odds = 100
    return GetWellSpace_Odds
...
Goal.Act43 = function (arg0, arg1, arg2)
    local f38_local0 = 0
    local f38_local1 = 0
    arg1:AddSubGoal(GOAL_COMMON_ComboAttackTunableSpin, 10, 3003, TARGET_ENE_0, 9999, f38_local0, f38_local1, 0, 0)
    GetWellSpace_Odds = 100
    return GetWellSpace_Odds
...
Goal.Act45 = function (arg0, arg1, arg2)
    local f40_local0 = 0
    local f40_local1 = 0
    arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, 3090, TARGET_ENE_0, 9999, f40_local0, f40_local1, 0, 0)
    GetWellSpace_Odds = 100
    return GetWellSpace_Odds
...
Goal.Kengeki_Activate = function (arg0, arg1, arg2, arg3)
    ...
    elseif f42_local0 == 200215 then
        if f42_local4 >= 5 then
            ...
            f42_local1[5] = 30
            f42_local1[20] = 20
            if f42_local4 <= 2 - arg1:GetMapHitRadius(TARGET_SELF) - 0.5 then
                f42_local1[4] = 100
                f42_local1[20] = 35
            end
        end
    ...
    elseif f42_local0 == 200225 then
        ...
        if f42_local4 <= 2.5 - arg1:GetMapHitRadius(TARGET_SELF) then
            f42_local1[6] = 100
            f42_local1[20] = 100
        else
            f42_local1[36] = 100
    ...
    f42_local1[8] = SetCoolTime(arg1, arg2, 3032, 30, f42_local1[8], 1)
...
Goal.Kengeki06 = function (arg0, arg1, arg2)
    local f48_local0 = arg0:GetRandam_Int(1, 100)
    arg1:ClearSubGoal()
...
Goal.Kengeki08 = function (arg0, arg1, arg2)
    ...
    local f50_local1 = 0
    arg1:ClearSubGoal()
    arg1:AddSubGoal(GOAL_COMMON_EndureAttack, 10, 3031, TARGET_ENE_0, 9999, f50_local0, f50_local1, 0, 0)
    arg0:SetTimer(6, 30)
    arg0:SetNumber(5, 1)
...
Goal.Kengeki10 = function (arg0, arg1, arg2)
    ...
    if arg0:GetNinsatsuNum() >= 2 or 0 < arg0:GetTimer(11) then
        arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, 3009, TARGET_ENE_0, 7, f52_local0, f52_local1, 0, 0)
    else
        local f52_local2 = arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, 3056, TARGET_ENE_0, 7, f52_local0, f52_local1, 0, 0)
        f52_local2:TimingSetTimer(11, 8, AI_TIMING_SET__ACTIVATE)
    end
...
Goal.Kengeki11 = function (arg0, arg1, arg2)
    local f53_local0 = 0
    local f53_local1 = 0
    arg1:AddSubGoal(GOAL_COMMON_EndureAttack, 10, 3032, TARGET_ENE_0, 9999, f53_local0, f53_local1, 0, 0)
    arg0:SetTimer(6, 30)
    arg0:SetNumber(5, 1)
