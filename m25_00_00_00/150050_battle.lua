RegisterTableGoal(GOAL_MurabitoZombie_hataoriki_150050_Battle, "GOAL_MurabitoZombie_hataoriki_150050_Battle")
REGISTER_GOAL_NO_UPDATE(GOAL_MurabitoZombie_hataoriki_150050_Battle, true)
...
Goal.Act30 = function (arg0, arg1, arg2)
    ...
    arg1:AddSubGoal(GOAL_COMMON_SidewayMove, f13_local0, TARGET_ENE_0, f13_local2, f13_local1, true, true, -1)
    GetWellSpace_Odds = 0
    return GetWellSpace_Odds
...
Goal.Act35 = function (arg0, arg1, arg2)
    ...
    local f14_local3 = arg0:GetRandam_Float(2, 3.5)
    local f14_local4 = 3
    local f14_local5 = 0
    local f14_local6 = arg0:GetDist(TARGET_FRI_0)
    local f14_local7 = arg0:GetRandam_Int(1, 100)
    local f14_local8 = arg0:GetRandam_Float(6.5, 7.5)
    local f14_local9 = arg0:GetRandam_Float(5.5, 6.5)
    local f14_local10 = 999
    local f14_local11 = 100
    if f14_local0 >= 10 then
        Approach_Act(arg0, arg1, f14_local8, f14_local10, 0, 3)
    elseif f14_local0 >= 5 then

    elseif f14_local0 >= 3.5 then
        arg1:AddSubGoal(GOAL_COMMON_LeaveTarget, 3, TARGET_ENE_0, f14_local8, TARGET_ENE_0, false, 9910)
    else
        arg1:AddSubGoal(GOAL_COMMON_SpinStep, 5, 5201, TARGET_ENE_0, 0, AI_DIR_TYPE_B, 2)
    end
    local f14_local12 = arg1:AddSubGoal(GOAL_COMMON_SidewayMove, f14_local3, TARGET_ENE_0, f14_local2, arg0:GetRandam_Int(30, 45), true, true, 9910)
    f14_local12:TimingSetTimer(2, 4, UPDATE_SUCCESS)
    GetWellSpace_Odds = 0
    return GetWellSpace_Odds
...
Goal.Act36 = function (arg0, arg1, arg2)
    ...
    arg1:AddSubGoal(GOAL_COMMON_ApproachTarget, 3, POINT_EVENT, f15_local0, POINT_EVENT, false, -1)
...
Goal.Damaged = function (arg0, arg1, arg2)
    local f18_local0 = arg0:GetHpRate(TARGET_SELF)
    ...
    local f18_local4 = 0
    if f18_local3 <= 33 then
        arg1:ClearSubGoal()
        local f18_local5 = arg1:AddSubGoal(GOAL_COMMON_SpinStep, StepLife, 5211, TARGET_ENE_0, TurnTime, AI_DIR_TYPE_B, 0)
        f18_local5:TimingSetTimer(3, 6, UPDATE_SUCCESS)
        return true
    elseif f18_local3 <= 67 then
