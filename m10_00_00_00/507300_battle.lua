...
Goal.Act20 = function (arg0, arg1, arg2)
    ...
    if arg0:GetNumber(9) == 0 then
        local f19_local1 = arg1:AddSubGoal(GOAL_COMMON_AttackTunableSpin, 10, 3012, TARGET_ENE_0, 9999, 0, 0, 0, 0)
        f19_local1:TimingSetNumber(9, 1, AI_TIMING_SET__ACTIVATE)
...
Goal.Act21 = function (arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_AttackTunableSpin, 10, 20000, TARGET_ENE_0, 9999, 0, 0, 0, 0)
    local f20_local0 = arg1:AddSubGoal(GOAL_COMMON_AttackTunableSpin, 10, 3012, TARGET_ENE_0, 9999, 0, 0, 0, 0)
    f20_local0:TimingSetNumber(9, 1, AI_TIMING_SET__ACTIVATE)
    return 0
...
Goal.Act31 = function (arg0, arg1, arg2)
    local f22_local0 = 0
    local f22_local1 = 0
    local f22_local2 = arg0:GetNumber(0)
    local f22_local3 = 7.5
    if f22_local2 == 1 then
        arg1:AddSubGoal(GOAL_COMMON_ApproachTarget, 3, TARGET_ENE_0, f22_local3, TARGET_SELF, true, -1)
        local f22_local4 = arg1:AddSubGoal(GOAL_COMMON_AttackTunableSpin, 10, 3043, TARGET_ENE_0, 9999, f22_local0, f22_local1, 0, 0)
        f22_local4:SetFailedEndOption(AI_GOAL_FAILED_END_OPT__PARENT_NEXT_SUB_GOAL)
    ...
    elseif f22_local2 == 2 then
        arg1:AddSubGoal(GOAL_COMMON_ApproachTarget, 3, TARGET_ENE_0, f22_local3, TARGET_SELF, false, -1)
        local f22_local4 = arg1:AddSubGoal(GOAL_COMMON_AttackTunableSpin, 10, 3044, TARGET_ENE_0, 9999, f22_local0, f22_local1, 0, 0)
        f22_local4:SetFailedEndOption(AI_GOAL_FAILED_END_OPT__PARENT_NEXT_SUB_GOAL)
...
Goal.Interrupt = function (arg0, arg1, arg2)
    ...
    if arg1:IsInterupt(INTERUPT_EventRequest) then
        local f23_local1 = arg1:GetEventRequest()
