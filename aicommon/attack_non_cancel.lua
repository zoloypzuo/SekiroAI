...
REGISTER_DBG_GOAL_PARAM(GOAL_COMMON_AttackNonCancel, 1, "?U?????", 0)
REGISTER_DBG_GOAL_PARAM(GOAL_COMMON_AttackNonCancel, 2, "????????", 0)
REGISTER_DBG_GOAL_PARAM(GOAL_COMMON_AttackNonCancel, 3, "?U???O??????", 0)
REGISTER_DBG_GOAL_PARAM(GOAL_COMMON_AttackNonCancel, 4, "???????p?x", 0)
...
function AttackNonCancel_Activate(arg0, arg1)
    ...
    local f1_local11 = arg1:GetParam(5)
    local f1_local12 = arg1:GetParam(6)
