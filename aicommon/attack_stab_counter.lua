...
REGISTER_DBG_GOAL_PARAM(GOAL_COMMON_StabCounterAttack, 1, "?U?????", 0)
REGISTER_DBG_GOAL_PARAM(GOAL_COMMON_StabCounterAttack, 2, "????????", 0)
REGISTER_DBG_GOAL_PARAM(GOAL_COMMON_StabCounterAttack, 3, "?U???O??????", 0)
