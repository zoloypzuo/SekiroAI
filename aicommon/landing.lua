...
function LiftOff_Update(arg0, arg1)
    ...
    if (f2_local2 == GOAL_RESULT_Success or f2_local2 == GOAL_RESULT_Failed) and (not not arg0:IsLanding() or f2_local1 < f2_local0) then
        arg1:AddSubGoal(GOAL_COMMON_Attack, 10, 9520, TARGET_NONE, DIST_None)
    end
    local f2_local3 = arg0:IsLanding()
...
function Landing_Landing_Update(arg0, arg1)
    ...
    if (f14_local0 == GOAL_RESULT_Success or f14_local0 == GOAL_RESULT_Failed) and not arg0:IsLanding() then
        arg1:AddSubGoal(GOAL_COMMON_Attack, arg1:GetLife(), 9510, TARGET_NONE, DIST_None)
    end
